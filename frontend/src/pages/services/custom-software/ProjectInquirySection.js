    ...
    <section className="bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-red-600 font-semibold uppercase tracking-wide mb-6"
        >
        ...
        >
          ...
          <textarea
            ...
            className="w-full h-48 border border-black px-6 py-4 text-gray-700 outline-none resize-none focus:ring-2 focus:ring-black"
          />

          {/* reCAPTCHA (UI only) */}
          <div className="border border-black w-fit px-6 py-4 flex items-center gap-4">
...
const SelectField = ({ label }) => (
  <div className="relative">
    ...
    <FaChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-black" />
  </div>
);
